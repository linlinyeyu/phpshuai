    ...
    if (ajaxForm_list.length) {
        ...
        Wind.use('ajaxForm', 'artDialog', function () {
            ...
            $('button.js-ajax-submit').on('click', function (e) {
                ...
                var check_method = form.attr('submit-check');
                if(check_method && window[check_method] && window[check_method]() == false){
                    return ;
                }
                //ie处理placeholder提交问题
                if ($.browser.msie) {
