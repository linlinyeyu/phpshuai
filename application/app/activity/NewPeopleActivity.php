...
class NewPeopleActivity extends Activities{
	public function getActivity(){
		...
		$fields = "g.goods_id,g.shop_price,g.name,g.sale_count,concat('$host',g.cover) as cover,sg.new_full_cut";
		$goods = D("special_model")->getSpecialGoods($condition,$fields,"",$this->page,8);
